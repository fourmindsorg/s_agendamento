#!/bin/bash
# Deploy rápido da aplicação Django

echo "=== DEPLOY RÁPIDO DJANGO ==="

# Instalar dependências básicas
sudo apt update -y
sudo apt install -y python3 python3-pip python3-venv nginx supervisor postgresql-client libpq-dev
...
sudo -u django /opt/s-agendamento/venv/bin/pip install django gunicorn psycopg2-binary

# Criar app Django básico
