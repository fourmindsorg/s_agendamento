#!/bin/bash
# User-data script para deploy automático da aplicação Django

echo "=== INICIANDO DEPLOY AUTOMÁTICO ===" > /var/log/deploy.log
...
echo "=== DEPLOY CONCLUÍDO ===" >> /var/log/deploy.log
