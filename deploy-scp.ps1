...
scp -i $env:USERPROFILE\.ssh\id_rsa_github -o StrictHostKeyChecking=no core/settings_production.py ubuntu@fourmindstech.com.br:/tmp/settings_production.py

# 3. Mover arquivo para o local correto
Write-Host "📝 Instalando arquivo..." -ForegroundColor Yellow
ssh -i $env:USERPROFILE\.ssh\id_rsa_github -o StrictHostKeyChecking=no ubuntu@fourmindstech.com.br "sudo mv /tmp/settings_production.py /home/django/sistema-de-agendamento/core/settings_production.py && sudo chown django:django /home/django/sistema-de-agendamento/core/settings_production.py"
