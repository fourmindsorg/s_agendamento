...
# Script para executar deploy manual na EC2
# Este script deve ser executado diretamente no console da EC2

echo "🚀 INICIANDO DEPLOY MANUAL VIA CONSOLE EC2"
echo "=========================================="
...
echo "3. Aguarde propagação DNS (5-15 minutos)"
